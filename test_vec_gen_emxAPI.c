/*
 * test_vec_gen_emxAPI.c
 *
 * Code generation for function 'test_vec_gen_emxAPI'
 *
 */
...
emxArray_creal_T *emxCreateND_creal_T(int numDimensions, int *size)
{
  ...
  int numEl;
  int i;
  b_emxInit_creal_T(&emx, numDimensions);
  numEl = 1;
...
/* End of code generation (test_vec_gen_emxAPI.c) */
